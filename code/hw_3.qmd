...
## d.
I am showing the amount of different caffeinated beverages I have consumed throughout the past month and a half. The most caffinated beverage begins on the left and the amount of caffeine decreases to the right, and the rainbow background is in reference to the quantity getting higher as the drinks are taller. I was influenced by my oma's watercolor paintings, and decided to use watercolor because of this. It was created by first creating a graph with beverage count, sketching a count onto the paper, and then painting. 
