...
ggplot(drought_exp_clean, aes(x = water_treatment, y = total_g)) + # choose data
  ...
  scale_color_manual(values = c("Well watered" = "darkturquoise", "Drought stressed" = "coral1")) +  # Custom colors
  facet_wrap(~ species_name) +  # Facet by species
  theme_minimal() + # simple theme
  theme(legend.position = "none") +  # Remove legend
  labs(x = "Water Treatment", y = "Total Biomass Growth (g)", title = "Model Predictions by Species and Water Treatment") +
